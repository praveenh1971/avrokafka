...
public class FileSourceTask extends SourceTask {
    ...
    private int batchSize = FileSourceConnect.DEFAULT_TASK_BATCH_SIZE;
    ...
    /* visible for testing */
    FileSourceTask(int initialBufferSize) {
        buffer = new char[initialBufferSize];
    }

    @Override
    public String version() {
        return new FileSourceConnect().version();
    }

    @Override
    public void start(Map<String, String> props) {
        filename = props.get(FileSourceConnect.FILE_CONFIG);
        ...
        // Connector
        topic = props.get(FileSourceConnect.TOPIC_CONFIG);
        batchSize = Integer.parseInt(props.get(FileSourceConnect.TASK_BATCH_SIZE_CONFIG));
    }
